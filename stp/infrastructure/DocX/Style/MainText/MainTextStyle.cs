...
namespace infrastructure.DocX.Style.MainText
{
    public static class MainTextStyle
    {

        public static void allTextStyle(Xceed.Words.NET.DocX doc)
        {
            doc.MarginLeft = 0;    
            doc.MarginRight = 0;   
            doc.MarginTop = 0;    
        ...
        public static void HeaderOneLevel(Paragraph paragraph, bool AllCaps = false)
        {
            if(AllCaps)
            {
