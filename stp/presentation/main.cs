...
class Program
{
    static void Main(String[] args)
    {
        ...
        var docxPipeline = PipelineFactory.CreateDocXPipeline(docxContext, options);
        ...
        var openXmlPipeline = PipelineFactory.CreateOpenXMLPipeline(openXmlContext, options);
